...
app.command("analyze", help="Analyse a ROS1 package and report migration complexity.")(_analyze_fn)
app.command("status", help="Show the status of an in-progress or completed migration.")(_status_fn)
